...
* 对于retina屏幕来说1px = 2dp 所以一像素边框的话会显示的比较粗
    * 0.5px的线条
    ...
    .border:after{
        ...
        -webkit-transform:sacle(1,.5);
        transform:scale(1,.5);
     }
    ```
 * 0.5px 的边框:先定义1px 的圆角边框，然后拉伸到宽高的2倍，在使用``transform:scale(0.5)`` 缩放为原来的0.5倍。
...
相比于em : em 是根据父级元素的宽高来计算该元素的宽高，但是如果嵌套太多层的话就很难计算子集元素的宽
...
* <font color = "#F87219" size = "2px"> 参考资料</font>
    ...
    * [移动端字体](https://leohxj.gitbooks.io/front-end-database/content/user-interface/mobile-fonts.html)
    * [0.5px像素问题](http://www.cnblogs.com/PeunZhang/p/4709822.html)
    * [移动端只是整理-白树](http://www.cnblogs.com/PeunZhang/p/3407453.html)
